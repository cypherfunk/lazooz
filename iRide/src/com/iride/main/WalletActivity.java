 ...
 */
public class WalletActivity extends Activity implements LocationListener, ServerResponseListener {
    /**
    ...
    /**
     * The flags to pass to {@link com.iride.main.util.SystemUiHider#getInstance}.
     */
    private static final int HIDER_FLAGS = SystemUiHider.FLAG_HIDE_NAVIGATION;

    /**
     * The instance of the {@link com.iride.main.util.SystemUiHider} for this activity.
     */
        ...
        if(prevLat != 0.0 && prevLon != 0.0)
        {
          ...
          // lastLocation = location; // assign the current location to lastLocation.
            ...
            if(distanceMeters>100)
            {
                ...
                lastLocation = location; // assign the current location to lastLocation.
                url+=param;
                final Serverconnector connector = new Serverconnector(WalletActivity.this, WalletActivity.this, url, null,
